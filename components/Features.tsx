    ...
    <section id="features" className="py-24 relative overflow-hidden">
      <div className="max-w-screen-2xl mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-block mb-4 px-4 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-100 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 text-xs font-bold tracking-wide uppercase">
            Key Capabilities
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight">Everything you need to<br />land the perfect job.</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="p-8 lg:p-10 rounded-3xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-white/60 dark:border-slate-800 shadow-lg hover:shadow-emerald-100/40 dark:hover:shadow-emerald-900/20 transition-all duration-500 group">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Deep ATS Audit</h3>
          ...
          <div className="p-8 lg:p-10 rounded-3xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-white/60 dark:border-slate-800 shadow-lg hover:shadow-emerald-100/40 dark:hover:shadow-emerald-900/20 transition-all duration-500 group">
            <div className="w-14 h-14 bg-purple-50 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              <PenTool className="text-purple-600 dark:text-purple-400" size={28} />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Section-wise AI Builder</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-8 lg:p-10 rounded-3xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-white/60 dark:border-slate-800 shadow-lg hover:shadow-emerald-100/40 dark:hover:shadow-emerald-900/20 transition-all duration-500 group">
            <div className="w-14 h-14 bg-amber-50 dark:bg-amber-900/30 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              <Lightbulb className="text-amber-600 dark:text-amber-400" size={28} />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Contextual Suggestions</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-8 lg:p-10 rounded-3xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-white/60 dark:border-slate-800 shadow-lg hover:shadow-emerald-100/40 dark:hover:shadow-emerald-900/20 transition-all duration-500 group">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Final AI Verification</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
