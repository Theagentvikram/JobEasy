        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-4">
              ...
              <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white dark:bg-black text-gray-700 dark:text-white border border-gray-200 dark:border-dark-gray px-8 py-4 rounded-full font-semibold hover:border-emerald-200 dark:hover:border-emerald-700 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/30 transition-all duration-300 shadow-sm">
          ...
          <div className="relative z-10 mx-auto w-full max-w-lg">
            ...
            <div className="bg-white/80 dark:bg-dark-gray/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-100 dark:border-dark-gray overflow-hidden transition-all duration-500 hover:shadow-emerald-900/10 dark:hover:shadow-emerald-900/20">
              <div className="p-6 border-b border-gray-100 dark:border-dark-gray bg-white/50 dark:bg-black/50">
              ...
              <div className="p-6">
                {!quickResult ? (
                  ...
                  <div className="text-center animate-fade-in">
                    ...
                    <div className="bg-white dark:bg-dark-gray rounded-xl p-5 mb-6 text-left shadow-sm border border-emerald-100 dark:border-emerald-900/30 relative overflow-hidden group cursor-pointer" onClick={onStart}>
                      <div className="flex items-center gap-3 mb-3 border-b border-gray-50 dark:border-dark-gray pb-2">
                        <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-black flex items-center justify-center text-gray-500 dark:text-gray-400">
                          <FileCheck size={16} />
                        </div>
                        <div>
                      ...
                      {/* Unlock overlay */}
                      <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/60 dark:bg-black/60 backdrop-blur-[2px] transition-all group-hover:bg-white/40 dark:group-hover:bg-black/40">
