    ...
    <section id="pricing" className="py-24 bg-white/40 border-y border-white/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mb-8">Invest in your career for less than the cost of a coffee.</p>

          {/* Student Toggle */}
          <div className="flex items-center justify-center gap-3">
            <span className={`text-sm font-semibold ${!isStudent ? 'text-gray-900' : 'text-gray-500'}`}>Standard</span>
            <button
              onClick={() => setIsStudent(!isStudent)}
              className={`w-14 h-8 rounded-full p-1 transition-colors duration-300 ${isStudent ? 'bg-emerald-500' : 'bg-gray-300'}`}
            >
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* Starter */}
          <div className="p-8 bg-white/70 rounded-3xl border border-gray-100 shadow-sm flex flex-col hover:border-emerald-100 transition-colors">
            <div className="mb-6">
          ...
          <div className="p-8 bg-white/70 rounded-3xl border border-gray-100 shadow-sm flex flex-col hover:border-emerald-100 transition-colors">
            <div className="mb-6">
              ...
              <div className="mt-4 flex items-baseline">
                {isStudent ? (
                  <>
                    <span className="text-4xl font-bold tracking-tight text-gray-900">$14.50</span>
            ...
            <button
              ...
              disabled={!!loadingPlan}
              className="w-full py-3 px-4 rounded-xl border-2 border-gray-200 text-gray-900 font-semibold hover:border-gray-900 transition-colors flex items-center justify-center gap-2"
            >
