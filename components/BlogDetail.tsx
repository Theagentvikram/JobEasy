...
const BLOG_POSTS: Record<string, any> = {
    "ats-2024": {
      ...
      <h3 class="text-2xl font-bold text-gray-900 mb-4">1. Use Standard Formatting</h3>
      ...
      <h3 class="text-2xl font-bold text-gray-900 mb-4">2. Keywords are King</h3>
      <p class="mb-6 text-gray-600 leading-relaxed">
      ...
      <h3 class="text-2xl font-bold text-gray-900 mb-4">3. Save as PDF (correctly)</h3>
      <p class="mb-6 text-gray-600 leading-relaxed">
    ...
    "bullet-points": {
      ...
      <div class="bg-emerald-50 p-6 rounded-xl border border-emerald-100 my-8">
        <p class="font-bold text-emerald-800 text-lg text-center">
    ...
    if (!post) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-8">
                ...
                <button onClick={() => navigate('/')} className="text-emerald-600 hover:underline">Return Home</button>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <main className="pt-24 pb-24">
                ...
                <div className="max-w-4xl mx-auto px-6 mb-12">
                    <button
                        onClick={() => navigate('/')}
                        className="group flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-emerald-600 mb-8 transition-colors"
                    >
                    ...
                    <div className="flex items-center justify-between border-y border-gray-100 py-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-gray-500">Editor, JobEasy</div>
                            </div>
                        </div>
                ...
                <div className="max-w-3xl mx-auto px-6">
                    <div
                        className="prose prose-lg prose-emerald text-gray-600"
